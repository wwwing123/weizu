    ...
    Vue.prototype.$loading = function (tips, type) {
        if (type == 'close') {
            ...
            var loadTpl = Vue.extend({
                ...
                template: '<div v-show="show" class="lx-load-mark"><div class="lx-load-box"><div class="lx-loading"><img src="./static/loading.png" width=40></div><div class="lx-load-content">' + tips + '</div></div></div>'
            });
