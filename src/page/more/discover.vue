...
<div>
    ...
    <div v-if="activeTab === 'house'">
        ...
        <div v-bind:class="{'top-bottom-btn-zw': !TopBottom}" class="Content-card">
            <DivcoverTab :listData="House_Data" :activeTab="'house'" @update="DiscoverLogin"></DivcoverTab>
        </div>
    </div>
    <div v-if="activeTab === 'roomie'">
        ...
        <div v-bind:class="{'top-bottom-btn-zw': !TopBottom}" class="Content-card">
          <DivcoverTab :listData="Roomie_Data" :activeTab="'roomie'" @update="DiscoverLogin"></DivcoverTab>
        </div>
    </div>
    <div v-if="activeTab === 'friend'">
        ...
        <div v-bind:class="{'top-bottom-btn-zw': !TopBottom}" class="Content-card">
          <DivcoverTab :listData="Friend_Data" :activeTab="'friend'" @update="DiscoverLogin"></DivcoverTab>
        </div>
    </div>
    <div v-if="activeTab === 'unused'">
        ...
        <div v-bind:class="{'top-bottom-btn-zw': !TopBottom}" class="Content-card">
          <DivcoverTab :listData="Unused_Data" :activeTab="'unused'" @update="DiscoverLogin"></DivcoverTab>
        </div>
    </div>
</div>
</template>
<script>
  import DivcoverTab from '../../components/discover-tab';
const address = {
  '北京': ['北京'],
